...
<%@ page import="com.mythredz.htmluibeans.LostPasswordChoose" %>
...
<%
    if (request.getParameter("action") != null && request.getParameter("action").equals("choose")) {
        try {
            ...
            lostPasswordChoose.setJ_captcha_response(com.mythredz.htmlui.Textbox.getValueFromRequest("j_captcha_response", "Squiggly Letters", true, DatatypeString.DATATYPEID));
