...
import com.mythredz.systemprops.WebAppRootDir;
...
public class ApplicationStartup implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent cse) {
       ...
       //Configure some dir stuff
        ...
        logger.info("MYTHREDZ Application Started!  Let's sew some stuff!");
        SendXMPPMessage xmpp = new SendXMPPMessage(SendXMPPMessage.GROUP_SYSADMINS, "myThredz Application started! ("+WebAppRootDir.getUniqueContextId()+")");
        xmpp.send();
    }
    ...
    public void contextDestroyed(ServletContextEvent cse) {
        ...
        //Notify sysadmins
        SendXMPPMessage xmpp = new SendXMPPMessage(SendXMPPMessage.GROUP_SYSADMINS, "myThredz Application shut down! ("+WebAppRootDir.getUniqueContextId()+")");
        xmpp.send();
        //Shut down Hibernate
        try{
