package com.mythredz.cache.providers.jboss;

import com.mythredz.cache.providers.CacheProvider;
import com.mythredz.systemprops.WebAppRootDir;
import com.mythredz.startup.ApplicationStartup;
...
public class JbossTreeCacheAOPProvider implements CacheProvider {
    ...
    private static void setupCache(){
        Logger logger = Logger.getLogger("com.mythredz.cache.providers.jboss.JbossTreeCacheAOPProvider");
        try{
    ...
    public String getCacheStatsAsHtml() {
        ...
        mb.append(com.mythredz.cache.providers.jboss.CacheDumper.getHtml("/", 10));
        String[] keys = getKeys("");
