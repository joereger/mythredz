 ...
 */
public class WiserMessageDneero {
	private final static Logger log = LoggerFactory.getLogger(WiserMessageDneero.class);

	WiserDneero wiserDneero;
	...
	WiserMessageDneero(WiserDneero wiserDneero, String envelopeSender, String envelopeReceiver, InputStream stream)
	{
		this.wiserDneero=wiserDneero;
	...
	public MimeMessage getMimeMessage() throws MessagingException
	{
		if (message == null)
		{
			 message = new MimeMessage(this.wiserDneero.getSession(), stream);
		}
		return message;
	}
