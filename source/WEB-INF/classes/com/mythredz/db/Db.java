...
public class Db {
  ...
  public static Connection getConnection(){
        return com.mythredz.db.proxool.Db.getConnection();
  }
  ...
  */
  public static String[][] RunSQL(String sql, int recordstoreturn) {
    if (InstanceProperties.haveValidConfig() || InstanceProperties.haveNewConfigToTest()){
        return com.mythredz.db.proxool.Db.RunSQL(sql, recordstoreturn);
    } else {
        return new String[0][];
    }
  }
  ...
  */
  ...
  public static int RunSQLUpdate(String sql){
    if (InstanceProperties.haveValidConfig() || InstanceProperties.haveNewConfigToTest()){
       return com.mythredz.db.proxool.Db.RunSQLUpdate(sql);
    } else {
        return 0;
    }
  }
  ...
  public static int RunSQLInsert(String sql, boolean isloggingon){
    if (InstanceProperties.haveValidConfig() || InstanceProperties.haveNewConfigToTest()){
       return com.mythredz.db.proxool.Db.RunSQLInsert(sql, isloggingon);
    } else {
        return 0;
    }
  }
  ...
  public static String printDriverStats() throws Exception {
        return com.mythredz.db.proxool.Db.printDriverStats();
  }

  public static void recordToSqlDebugCache(String sql){
      Logger logger = Logger.getLogger("com.mythredz.db.Db");
      logger.debug(sql);
  }
